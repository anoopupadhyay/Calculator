...
public class AdditionTest extends TestCase{
	...
	public void testSumOfTwoOneFloatAndIntegerNumbers() {
		...
		System.out.println("testSumOfTwoOnePositiveAndNegativeNumbers: "+add.addition(400.50,300));
	}
	public void testSumOfTwoFloatNumbers() {
		assertEquals(700.00,add.addition(400.50,299.50));
		System.out.println("testSumOfTwoOnePositiveAndNegativeNumbers: "+add.addition(400.50,299.50));
	}
}